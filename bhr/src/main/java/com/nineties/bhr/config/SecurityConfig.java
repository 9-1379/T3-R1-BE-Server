    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/api/hrCard/*","/api/join","/*","/login", "/api/login", "/api/login/join", "/employees/{id}", "/emp/dashboard/{id}", "/attendance/startWork", "/attendance/endWork","attendance/record/{id}").permitAll()
