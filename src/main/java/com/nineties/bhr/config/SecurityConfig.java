...
<<<<<<< HEAD
                        .requestMatchers("/api/hrCard/*","/api/join","/api/join/*","/*","/login", "/api/login", "/api/login/join", "/employees/{id}", "/attendance/startWork", "/attendance/endWork","attendance/record/{id}").permitAll()
=======
