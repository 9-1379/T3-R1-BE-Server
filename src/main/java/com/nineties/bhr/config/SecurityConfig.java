    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/api/admin/badge/*","/api/hrCard/*","/api/join","/*","/login", "/api/login", "/api/login/join", "/employees/{id}", "/attendance/startWork", "/attendance/endWork","attendance/record/{id}", "/static/**", "/badge/**").permitAll()
