...
public interface EmployeesRepository extends JpaRepository<Employees, String> {
    ...
    @Query("SELECT e.id as id, e.empNo as empNo, e.name as name, e.email as email, e.position as position, e.jobId as jobId, e.profilePicture as profilePicture, e.introduction as introduction, e.dept.deptName as deptName FROM Employees e")
